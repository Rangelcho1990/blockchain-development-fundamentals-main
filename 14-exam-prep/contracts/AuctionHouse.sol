...
contract AuctionHouse is Ownable{
    ...
    function createAuction(
        ...
        uint256 actionId = _nextAuctionId++;
    ...
    function bid(uint256 auctionId) external payable {
        ...
        // check for snaiping and extend time
    ...
    function claimBid(uint256 auctionId) external {
        // Any locked ETH is returned to bidders if they were not outbid
